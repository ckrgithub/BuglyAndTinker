...
import com.ckr.bugly.BuildConfig;
import com.ckr.bugly.R;
import com.ckr.bugly.lifecycle.AppTracker;
import com.ckr.bugly.listener.MyUpgradeListener;
...
public class BuglyConfig {
    ...
    public static void init(@NonNull Application application) {
        ...
        Logd(TAG, "init: startTime:" + startTime);
...
//      </editor-fold>
        ...
        Logd(TAG, "init: usedTime:" + (System.currentTimeMillis() - startTime));
    }
