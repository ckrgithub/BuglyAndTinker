...
public class ChannelUtil {
	 ...
	 * @param context
	 */
	private static void checkIsNull(Context context) {
		if (context == null) {
	 ...
	 * @return
	 */
	public static String getChannelInfo(Context context, String apkPath) {
		Log.d(TAG, "getChannelInfo: apkPath:" + apkPath);
		checkIsNull(context);
		String channel = context.getString(R.string.upgrade_default_channel);
